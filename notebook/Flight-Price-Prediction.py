...
try:
    ...
    @st.cache_resource
    def load_model():
        with open(r"D:\GUVI-DS\Mini-Project4\Gradient Boosting_pipeline.pkl", "rb") as model_file:
...
# Tabs layout
tabs = st.tabs(["✈️ Flight Price Prediction", "📊 Price Trends"])
...
with tabs[1]:
    ...
    sns.boxplot(x='Total_Stops', y='Price', data=df_cleaned, ax=axes[0, 0])
    ...
    sns.violinplot(x='Airline', y='Price', data=df_cleaned, ax=axes[3, 0])
